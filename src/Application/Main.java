		...
		do {
			do {
				...
				affiche = scanner.nextLine().toUpperCase();
					if(affiche.equalsIgnoreCase("A")) {
						...
						System.out.println("	2 - nombre de livres �lectroniques et de romans graphiques");
						System.out.println("	3 - nombres de membres qui ont un livre en emprunt");
						System.out.println("	4 - nombre de livres emprunt�s");
						System.out.println("	5 - nombre de livres en retard");
						System.out.println("	0 - quitter");
					}else {
						System.out.println("Votre entrer au clavier est incorrecte r�essayer");
					}
			...
			if(choix >= 0 && choix<=5) {
				...
				case 5:
					break;
				default:
					System.out.println("bye bye, � bient�t");
					end=false;
					break;
				}
			}
